...
export const my: Messages = {
  ...
  mvp: {
    ...
    body: 'ဒီနေ့ ဘယ်သူ အကောင်းဆုံးလဲ? ရွေးပြီးမှ ရလဒ် မြင်ရပါမည်။',
    changeBody: 'စိတ်ပြောင်းသွားလား? အခြားတစ်ယောက်ကို နှိပ်ပါ။',
    hidden: 'မဲပေးပြီးမှ အရေအတွက် ပေါ်ပါမည်။',
    yours: 'သင့်မဲ',
  ...
  teams: {
    ...
    neverSettled: 'ဤအသင်းများကို အတည်မပြုခဲ့သဖြင့် ပွဲစဉ် မထွက်ခဲ့ပါ။',
