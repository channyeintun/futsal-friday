...
export const my: Messages = {
  ...
  gate: {
    tagline: 'ဝင်ရန် အဖွဲ့ကုဒ်ကို ရိုက်ထည့်ပါ',
    whichOne: 'သင်က ဘယ်သူလဲ?',
    inviteCode: 'ဖိတ်ကြားကုဒ်',
    inviteHint: 'ပွဲစီစဉ်သူထံ တောင်းပါ',
    continue: 'ဆက်လုပ်မည်',
    checking: 'စစ်ဆေးနေသည်…',
    codeWrong: 'ဖိတ်ကြားကုဒ် မမှန်ပါ',
    couldNotCheck: 'ကုဒ်ကို စစ်ဆေး၍ မရပါ',
    couldNotSignIn: 'ဝင်ရောက်၍ မရပါ',
    emptyRoster: 'စာရင်းတွင် ဘယ်သူမှ မရှိသေးပါ။ စီစဉ်သူက ကစားသမားများကို အရင်ထည့်ရပါမည်။',
  },
