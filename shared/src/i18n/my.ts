...
export const my: Messages = {
  ...
  pay: {
    ...
    reference: 'လွှဲပြောင်းမှတ်ချက်',
    copyAccount: 'အကောင့်နံပါတ် ကူးမည်',
    ...
    editBody:
      'လူတိုင်းကို သူတို့ပေးရမယ့် ပမာဏနဲ့အတူ ပြပါမယ်။ ဘယ်သူမှ ချက်ထဲ ပြန်ရှာစရာ မလိုတော့ပါ။',
    setUp: 'ငွေပေးချေမှု အချက်အလက် ထည့်မည်',
    edit: 'ပြင်မည်',
    save: 'သိမ်းမည်',
    ...
    couldNotSave: 'အချက်အလက် မသိမ်းနိုင်ပါ',
  },
  ...
  profile: {
    ...
    shareCard: 'ကတ်ကို မျှဝေမည်',
    sharingCard: 'ကတ် ပြင်ဆင်နေသည်…',
    couldNotShare: 'ကတ် မလုပ်နိုင်ပါ',
    cardCaption: (name) => `${name} — Futsal Friday`,
  ...
  form: {
    label: (played, of) => `နောက်ဆုံး ${of} ပွဲအနက် ${played} ပွဲ ကစားခဲ့`,
  },
  ...
  board: {
    ...
    goalsBody: 'အက်ပ်စတင်ကတည်းက သွင်းခဲ့သော ဂိုးများ။',
    inARow: (count) => `${count} ပွဲ ဆက်တိုက်`,
    bestEver: (count) => `အများဆုံး ${count}`,
    goalCount: (count) => `${count} ဂိုး`,
    mvps: 'အကောင်းဆုံး',
    mvpBody: 'အဖွဲ့က အကောင်းဆုံးဟု မဲပေးခဲ့သော ပွဲများ။ သရေဖြစ်လျှင် အားလုံးအတွက် ရေတွက်သည်။',
    noMvpsYet: 'အကောင်းဆုံး ကစားသမား မရွေးရသေးပါ။',
    nobodyYet: 'အဆင့်တင်စရာ မရှိသေးပါ။ ပွဲတစ်ပွဲ ကစားလိုက်ပါ။',
    noGoalsYet: 'ဂိုး မမှတ်ရသေးပါ။ ပွဲပြီးရင် ဘယ်နှစ်ဂိုး သွင်းခဲ့လဲ ပြောပါ။',
    loading: 'ဇယား တွက်နေသည်…',
    you: 'သင်',
  },

  goals: {
    title: 'ဂိုး သွင်းခဲ့လား?',
    body: 'ဘယ်နှစ်ဂိုး သွင်းခဲ့လဲ? သင်နဲ့ စီစဉ်သူသာ ပြင်လို့ရပါသည်။',
    none: 'မသွင်းရပါ',
    mine: (count) => `${count} ဂိုး`,
    add: 'ဂိုး',
    total: 'ဂိုးများ',
    failed: 'သိမ်း၍ မရပါ',
  },
  ...
  invite: {
    ...
    expiresInDays: (days) => `${days} ရက် ကျန်သည်`,
    lessThanADay: 'တစ်ရက်အောက် ကျန်သည်',
    ...
    myDevice: 'အခြားနေရာတွင် ဝင်ရောက်မည်',
    myDeviceBody:
      'ဤလင့်ခ်ကို အခြားဘရောက်ဇာ၊ အခြားဖုန်း သို့မဟုတ် လက်ပ်တော့တွင် ဖွင့်ပါ။ ဘရောက်ဇာတစ်ခုစီ သီးခြား ဝင်ရောက်ရပါသည် — Chrome တွင် ဝင်ထားလျှင် Safari တွင် ဝင်ပြီးသား မဟုတ်ပါ။',
    removeAccess: 'နေရာတိုင်းမှ ထွက်ခိုင်းမည်',
    removeAccessBody:
      'သူဝင်ရောက်ထားသော ဘရောက်ဇာအားလုံးမှ ထွက်စေပြီး မသုံးရသေးသော လင့်ခ်ကိုလည်း ပယ်ဖျက်ပါမည်။ လင့်ခ်အသစ် လိုအပ်ပါမည်။',
    confirmRemove: (name) => `${name} ကို နေရာတိုင်းမှ ထွက်ခိုင်းမှာလား?`,
  ...
  pitch: {
    label: 'ကစားကွင်း — နေရာလွတ်တစ်ခုကို နှိပ်ပြီး ယူပါ',
    labelOnPitch: 'ကစားကွင်း — နေရာလွတ်တစ်ခုကို နှိပ်ပြီး ရွှေ့ပါ',
    labelRecord: 'ကစားကွင်း — စာရင်းပေးထားသူများ',
    tour: {
      tapInTitle: 'နေရာတစ်ခု ယူပါ',
      tapInBody: 'ကွင်းထဲဝင်ဖို့ နေရာလွတ်တစ်ခုကို နှိပ်လိုက်ပါ။ ကစားမယ့်စာရင်းထဲ တန်းရောက်သွားပါမယ်။',
      tapOutTitle: 'ကွင်းထဲ ရောက်နေပါပြီ',
      tapOutBody: 'စိတ်ပြောင်းသွားရင် ကိုယ့်ကတ်ကို တစ်ချက်နှိပ်ပြီး နောက်တစ်ချက် ထပ်နှိပ်ပါ။ နေရာ ပြန်လွတ်သွားပါမယ်။',
      moveTitle: 'တခြားနေရာ ပြောင်းချင်လား',
      moveBody: 'လွတ်နေတဲ့ နေရာတစ်ခုကို နှိပ်လိုက်ရင် အဲဒီကို ရွှေ့ပါမယ်။ ပွဲထဲက သင့်နေရာတော့ မပျောက်ပါဘူး။',
      gotIt: 'ရပါပြီ',
    },
    takeSpot: 'ဒီနေရာကို ယူမည်',
    moveHere: 'ဒီနေရာသို့ ပြောင်းမည်',
    spotsLeft: (left) => `${left} နေရာ ကျန်သေးသည်`,
    full: 'ကွင်း ပြည့်သွားပြီ',
    fullBody: 'နှိပ်လိုက်ရင် စောင့်ဆိုင်းစာရင်းထဲ ဝင်ပါမယ် — ပြုတ်တဲ့သူ အမြဲရှိပါတယ်။',
    noCap: 'ဒီပွဲမှာ နေရာ ကန့်သတ်ချက် မရှိပါ',
    noCapBody: 'စာရင်းသွင်းသူ အားလုံး ကစားရပါမည်။',
    yourSpot: 'သင့်နေရာ။ ထွက်ချင်ရင် နှိပ်ပါ။',
    leaveArmed: 'ထွက်ရန် နောက်တစ်ခါ နှိပ်ပါ',
    playerSpot: (name) => `${name} ပါဝင်သည်`,
    guestSpot: (name) => `${name} ၏ ဧည့်သည်`,
    yourGuest: 'သင့်ဧည့်သည်',
    joining: 'နေရာ ယူနေသည်…',
    moving: 'နေရာ ပြောင်းနေသည်…',
    leaving: 'နေရာမှ ထွက်နေသည်…',
    partyTooBig: (party, room) =>
      `${party} ယောက်စာ နေရာ လိုသည်။ ${room} နေရာသာ ကျန်သည်။`,
    benchLabel: 'စောင့်ဆိုင်းစာရင်း',
    joinWaitlist: 'စောင့်ဆိုင်းစာရင်းသို့ ဝင်မည်',
    yourWaitlistSpot: 'သင် စောင့်နေသည်။ ထွက်ရန် နှိပ်ပါ။',
    leaveWaitlistArmed: 'စောင့်ဆိုင်းစာရင်းမှ ထွက်ရန် နောက်တစ်ခါ နှိပ်ပါ',
    waitingSpot: (name) => `${name} စောင့်နေသည်`,
  },

  /* --------------------------------------------------------------- mvp */

  mvp: {
    title: 'အကောင်းဆုံး ကစားသမား',
    body: 'ဒီနေ့ ဘယ်သူ အကောင်းဆုံးလဲ? နာမည်တစ်ခုကို နှိပ်ပါ။',
    changeBody: 'စိတ်ပြောင်းသွားလား? အခြားတစ်ယောက်ကို နှိပ်ပါ။',
    yours: 'သင့်မဲ',
    takeItBack: 'မဲ ပြန်ရုပ်မည်',
    playersOnly: 'ကစားခဲ့သူများသာ မဲပေးနိုင်သည်။',
    turnout: (cast, of) => `${of} ဦးအနက် ${cast} ဦး မဲပေးပြီး`,
    votes: (count) => `မဲ ${count} မဲ`,
    leadingWith: (count) => `မဲ ${count} မဲဖြင့်`,
    shared: (count) => `မဲ ${count} မဲစီဖြင့် သရေ`,
    failed: 'မဲ သိမ်း၍ မရပါ',
  },

  /* -------------------------------------------------------- trash talk */

  talk: {
    title: 'နောက်ပြောင်စကား',
    count: (n) => `စာ ${n} စောင်`,
    empty: 'ဘယ်သူမှ မပြောရသေးပါ။ တစ်ယောက်ယောက် စတင်ရမည် 😏',
    emptyClosed: 'ဤပွဲအတွက် ဘာမှ မပြောခဲ့ကြပါ။',
    placeholder: 'တစ်ခုခု ပြောပါ',
    send: 'တင်မည်',
    remove: 'ပြန်ဖျက်မည်',
    tooLong: (max) => `နည်းနည်း ရှည်နေသည် — အများဆုံး ${max} လုံး။`,
    failed: 'တင်၍ မရပါ',
  },
  ...
  teams: {
    title: 'အသင်းများ',
    drawLabel: 'အသင်းခွဲခြင်း',
    opening: 'အသင်းများ ဖွင့်နေသည်',
    tapToSkip: 'ကျော်ရန် နှိပ်ပါ',
    split: 'အသင်းခွဲမည်',
    body: 'ရောက်လာသူ အားလုံးကို ကျပန်း ခွဲပေးပါမည်။ ဘယ်သူမဆို ထပ်ခွဲနိုင်သည်။',
    bodyBefore: 'စာရင်းပေးထားသူ အားလုံးကို ကျပန်း ခွဲပေးပါမည်။ ဘယ်သူမဆို ထပ်ခွဲနိုင်သည်။',
    notEnoughYet: 'စာရင်းပေးထားသူ မလုံလောက်သေးပါ။',
    nobodyYet: 'ဘယ်သူ ရောက်လာသည်ကို အရင်မှတ်ပါ — ငွေခွဲသည့် စာရင်းအတိုင်းပင် သုံးပါသည်။',
    howMany: 'အသင်း ဘယ်နှစ်သင်း ခွဲမလဲ?',
    onThePitch: (heads) => `ကွင်းထဲတွင် ${heads} ဦး`,
    willBe: (sizes) => `အသင်းအင်အား ${sizes}`,
    deal: 'အသင်းခွဲမည်',
    dealing: 'ခွဲနေသည်…',
    teamName: (letter) => `အသင်း ${letter}`,
    teamSize: (count) => `${count} ဦး`,
    guest: 'ဧည့်သည်',
    empty: 'တစ်ဦးမှ မရှိ',
    drawnBy: (name, when) => `${name} က ${when} ခွဲထားသည်`,
    shuffle: 'ထပ်ခွဲမည်',
    clear: 'ဖျက်မည်',
    missing: (count) => `နောက်ထပ် ${count} ဦး ရောက်လာသည်။ ထည့်ရန် ထပ်ခွဲပါ။`,
    dealThemIn: (count) => `အသင်းထဲ ထည့်မည် (${count})`,
    failed: 'အသင်း ခွဲ၍ မရပါ',

    /* ------------------------------------------- settling on a draw */
    confirm: 'ဤအသင်းများဖြင့် အတည်ပြုမည်',
    confirmHint: 'အားလုံး သဘောတူပြီလား? ဤသို့ဆိုလျှင် အသင်းများ အတည်ဖြစ်ပြီး ပွဲစဉ်များ ထွက်လာပါမည်။',
    settledBy: (name, when) => `${name} က ${when} အတည်ပြုထားသည်`,
    locked: 'အတည်ဖြစ်ပြီ။ ယခု အသင်းများကို စီစဉ်သူသာ ပြင်နိုင်သည်။',
    redoWarning: 'ထပ်ခွဲပါက အတည်ပြုထားသည် ပျက်ပြီး မှတ်ထားသော ရလဒ်များပါ ပျက်ပါမည်။',

    /* -------------------------------------------------- the fixtures */
    matches: 'ပွဲစဉ်များ',
    matchesHint: 'အသင်းတိုင်း အချင်းချင်း ကစားပါသည်။ ပွဲပြီးလျှင် ရလဒ် ထည့်ပါ။',
    neverSettled: 'ဤအသင်းများကို အတည်မပြုခဲ့သဖြင့် ပွဲစဉ် မထွက်ခဲ့ပါ။ ယခုမှ အတည်ပြုလျှင်လည်း ရပါသေးသည်။',
    notPlayed: 'မကစားရသေးပါ',
    scoreTitle: (first, second) => `${first} နှင့် ${second}`,
    markNotPlayed: 'မကစားရသေးဟု မှတ်မည်',
    scoredBy: (name) => `${name} က ထည့်သွင်းထားသည်`,
    record: (won, drawn, lost) => `နိုင် ${won} · သရေ ${drawn} · ရှုံး ${lost}`,
    scoreFailed: 'ရလဒ် သိမ်း၍ မရပါ',
  },
  ...
  home: {
    ...
    noneYet: 'ကစားပြီးသော ပွဲ မရှိသေးပါ။',
  ...
  toast: {
    ...
    youMoved: 'နေရာ ပြောင်းပြီးပါပြီ',
  ...
  payments: {
    ...
    collected: 'ရရှိပြီး',
    stillOwed: 'ကျန်ရှိ',
    changeTotal: 'ပမာဏ ပြင်မည်',
    changeTotalTitle: 'တစ်ဦးလျှင် ပေးရမည့် ပမာဏ ပြင်မည်',
    changeTotalBody:
    ...
    seeSession: 'အသင်းများနှင့် ကစားသူများ',
    splittingBetween: (heads) => `${heads} ဦး ကစားခဲ့သည်`,
    splitTitle: 'ငွေခွဲမည်',
    splitBody:
      'ကစားခဲ့သူများကိုသာ ကောက်ခံပါမည်။ ဝေစုများကို 1.000d နှင့် အနီးစပ်ဆုံး ဝိုင်းပါမည်။',
    perPersonCharge: 'တစ်ဦးလျှင် ဘယ်လောက် ပေးရမလဲ',
    enterEach: 'တစ်ဦးလျှင် ပေးရမည့် ပမာဏ။ 70k လို့ ရိုက်လို့ရသည်။',
    splitIt: 'ခွဲမည်',
    splitting: 'ခွဲနေသည်…',
    comesTo: (heads, total) => `${heads} ဦး ကစားခဲ့ · စုစုပေါင်း ${total}`,
    ...
    shareBody: (name) =>
      `${name} ကို ပမာဏ တစ်ခု သတ်မှတ် ကောက်ခံမည်။ ကျန်ငွေကို ကျန်သူများက ခွဲဝေပါမည်။`,
  ...
  history: {
    ...
    expandList: 'စာရင်းကို မျက်နှာပြင် အပြည့် ကြည့်မည်',
    collapseList: 'စာရင်းကို ပြန်ချုံ့မည်',
    settledUp: 'ရှင်းပြီး',
  ...
  admin: {
    ...
    confirmSignOut: 'ဤဘရောက်ဇာမှ ထွက်မှာလား?',
    ...
    clock: 'နာရီပုံစံ',
    clockBody: 'အက်ပ်တစ်ခုလုံးနှင့် သတိပေးချက်များတွင် အချိန်ပြပုံ။',
    language: 'ဘာသာစကား',
    languageBody: 'အက်ပ်၊ သတိပေးချက်များနှင့် ချက်သို့ ကူးသည့် စာသားကို ပြောင်းပါမည်။',
    sound: 'အသံ',
    soundBody: 'ခလုတ်နှိပ်တိုင်း အသံမြည်ပါမည်။ မလိုချင်ပါက ပိတ်ထားနိုင်ပါသည်။',
    soundOn: 'ဖွင့်',
    soundOff: 'ပိတ်',
    haptics: 'တုန်ခါမှု',
    hapticsBody:
      'နေရာယူသည့်အခါနှင့် နေရာမှ ထွက်သည့်အခါ ဖုန်း တုန်ခါပါမည်။ အခြားမည်သည့်အရာမျှ တုန်ခါမည်မဟုတ်ပါ။ အသံပိတ်ထားသော ဖုန်းတွင် တုန်ခါချင်မှ တုန်ခါပါမည်။',
    perspective: 'ကွင်းကို စောင်းပြရန်',
    perspectiveBody:
      'ဂိမ်းမျက်နှာပြင်များကဲ့သို့ ကွင်းကို အနောက်ဘက်သို့ စောင်းပြီး ဆွဲထားပါသည်။ ပိတ်လိုက်ပါက ကွင်းကို အပေါ်စီးမှ ဖြောင့်ဖြောင့် မြင်ရပါမည်။',
  },
  ...
  announce: {
    ...
    teaseLabel: 'ကိုယ်ပိုင် နောက်ပြောင်စကား',
    teaseHint: 'နာမည် တပ်ပြောလို့ရသည်။ ဗလာထားလျှင် အက်ပ်က ရွေးပေးပါမည်။',
    openers: [
